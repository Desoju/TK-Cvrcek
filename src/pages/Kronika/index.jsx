...
export const Kronika = () => {
  return (
    ...
    <h2>DEN 1.</h2>
      <p>První tábor TK Cvrček slavnostně začal! 🤩 </p>
      <p>Děti nám dnes konečně dorazily, a my se jim tak můžeme začít naplno věnovat! Hned po hladkém příjezdu jsme se prošli po tábořišti a pověděli si, jak se v táboře společně chovat, aby se nám tu dobře pobývalo. 🏕️ </p>
      <p>Potom už jsme se vrhli do víru her - po seznamovačkách jsme se rozdělili do cestovatelských týmů, v nichž budeme následující dva týdny soutěžit. Tématem letošního tábora je Cesta kolem světa, cílem všech týmů tak je objet všechny státy za co nejkratší dobu. 🌍 Týmy si k tomu také zvolily své dopravní prostředky - pojedou motorkami 🛵, vzducholoděmi 🌬️, ponorkami 🌊, koněspřežkami 🐎a traktory. 🚜 </p>
    ...
    <h2>DEN 3.</h2>
      ...
      <p>Tým Ponorka (modrá)🌊- Marťa S., Martin Ď., Štepán, Vojta, Maky, Gabča </p>
      <p>Tým Vzducholoď (zelená) 🌬️- Ondra, Lukáš, Peťa, Verča, Robin, Matěj </p>
      <p>Tým Koněsprežka (oranžová) 🐎 - Vašek, Kamča, Šimon, Zuzka, Lucka B., Andrew </p>
      <p>Tým Motorka (fialová)🏍️- Martin B., Emča, Maty K., Bety, Lenka, Honza </p>
      <p>Večer už nás čekal jen slavnostní táborák. Zpívalo se, hrálo se, a všichni jsme si večer moc užili🔥. </p>
    <h2>DEN 4.</h2>
      <p>Good morning! 🗽</p>
      <p>Hned ráno po pasové kontrole, rozcvičce a snídani jsme vyrazili na celodenní cestu napříč USA s vidinou navštívit co nejvíce států na mapě za jeden den. 🗺️
         Na cestu jsme se vydali ve třech skupinkách dělených dle věku či fyzické zdatnosti. 🚶‍♂️🚶‍♀️🚶🏻</p>
      <p>Skupina malých chodičů vyrazila dopoledne směrem na Lačnov, kde byla jejich první zastávka na hřišti. Po cestě potkali výběh se pštrosem, což jen víc umocnilo veškeré zážitky z cestovatelské horečky celého tábora. Poté se vydali ke Lhotě u Lysic, s několika zastávkami - obědovou, přestávkou na Městečko Palermo a taky se spoustou malých zastávek na hraní drobných her. Potom už skupinka zamířila do Kozárova, kde děti čekalo na závěr cesty zasloužené koupání. I přes dopolední deštík přišla voda k osvěžení vhod. 🗺️ </p>
    ...
    <h2>DEN 8.</h2>
      <p>Zdravíme z Norska ⛵</p>
      <p>Dnes jsme den odstartovali jako drsní a odvážní seveřané - vikingové. Posnídali jsme výborné rohlíky s medem a čajem, a následně se vydali na náročný boj s hadem světa🐍. Každý tým úspěšně zdolal tohoto tvora, a po obědě a odpoledním klidu část z nás zůstala v tábořišti a chystala táborák či hrála kratochvilné hry a druhá část se vydala koupat💧🏖️. </p>
      <p>Nebylo to ovšem naše poslední koupání dne. Po návratu z Kozárova následovala hra zvaná námořní bitva. Jednotlivé týmy si vyrobili lodě⚓️⛵️, a v průběhu hry se snažily co nejvíce namokřit papírový terčík ostatních lodí pomocí plastových stříkaček. </p>
      <p>K večeři byl vynikající vanilkový puding, a my už se pomalu odebíráme k dnešnímu slavnostnímu táboráku. </p>
      <p>Dobrou noc🌌</p>
    <h2>DEN 9.</h2>
      <p>Po náročných dnech strávených ve Skandinávii jsme se dostali až do známého státu arabského světa - Sýrie 👳‍♂️. V rámci dnešního dne jsme vyzkoušeli také improvizovaný ramadán - každé jídlo jsme museli jíst se zavřenýma nebo zavázanýma očima, abychom napodobili jezení pouze v noci. Pro některé to byla opravdu výzva a vyzkoušeli si mnoho různých kombinací chutí. 🍽️ </p>
      <p>Dopoledne si děti zahrály velice známou a oblíbenou hru a to  vlajkovanou hra skončila remízou 1:1. </p>
      <p>Po příchodu do tábora jsme navštívili tržnici, kde se každý tým seznámil se surovinami, například s hedvábím nebo kořením, které jsou pro tuto oblast typické. Úkolem bylo za levno nakoupit a za draho prodat. Poté jsme došli až do Damašku, hlavního města, kde jsme se pomocí velbloudů 🐫 snažili dostat do různých Syrských míst. Poté jsme jsme se ještě do večeře zabývali důkazy které si děti postupně plní a za ně dostávají různé výjimky jako např. házení letecké pošty na večerním nástupu  💌.... Ke konci putování se nám podařilo projít strašidelným lesem 🌳🌲, kde naše cesta skončila. Kam se naši dobrodruzi rozhodnou vydat dál?</p>
    <h2>DEN 10.</h2>
      <p>Ve druhém výletovém dni jsme dnes navštívili Austrálii a vydali se ji prozkoumávat. Cestovali jsme již časně od rána po rychlé rozcvičce a cestou jsme poznali spoustu australských zvířat. Měli jsme totiž na celou cestu úkoly k jednotlivým zástupcům australské fauny. 🦘 Navíc výletové skupiny soutěžily na motivy australských původních obyvatel v tom, kdo vytvoří svému vedoucímu nejhezčí tetování hennou. </p>
      <p>Nejmladší chodiči vyrazili zrána po žluté turistické značce směrem na Lysice, kde už se všechny děti těšily na zaslouženou zmrzlinu. 🍦 Po cestě ale museli ještě postupně plnit úkoly australských zvířat a pracovat na tetováních jejich vedoucích. Po obědě jsme vyšli pro změnu po červené zpět k táboru se spoustou zastávek na hry a hřiště. Vrátili jsme se s příjemně bolavýma nohama unavení po celodenní cestě. 👣 </p>
      <p>Skupina středních se vydala na cestu do Černé Hory🚶‍♂️🚶‍♀️ Po cestě jsme plnili nejen úkoly do dnešního programu, ale také jsme se inspirovali skupinou nejstarších a zkusili vyměnit krajíc chleba 🍞za co nejlepší potravinu. Z Černé Hory naše trasa vedla do Lysic a poté nazpět do tábora. Skončili jsme se zavařenými třešněmi a tartaletkou - z toho jsme byli nadšením bez sebe. </p>
      <p>Se skupinkou největších jsme se dnes vydali na své dobrodružství směrem do Brumova a na zříceninu hradu Osiky🏰. Poté se vydali směrem koupaliště Kozárov. Po cestě jsme měli za úkol vyměňovat předmety za lepší🛍️. Povedlo se nám sehnat bundu, konzervu kukuřice a malou mačetu (z ponožek, rohlíku a hřebíku). Následně jsme si našli místečko na  přespání nedaleko tábora u rozhledny babylon, kde dnes strávíme noc🏕️✨</p>
      <p>Po návratu jsme si odpočinuli a posilnili se večeří a ještě jsme za tmy vyrazili do lesa proplétat se pavučinami. 🕸️🕷️ Na nástupu jsme také oslavili prvního světoběžníka - nejvyšší hodnost cestovatelů v letošní celotáborové hře. Stal se jím Pepa Rousek, gratulujeme! 🥳 </p>
    </div>
  );
};